...
export default function IconButton(props: {src: any; onClick?: any; className?: string}){
    ...
    return <input type="image" src={props.src} className={"rounded-md bg-gray-200 " + (props.className ? props.className : "h-icon_button w-icon_button align-baseline")} onClick={onClick}/>;
}
