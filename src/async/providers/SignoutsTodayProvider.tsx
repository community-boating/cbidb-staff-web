...
export default function SignoutsTodayProvider(props: {children?: React.ReactNode}){
    return <GeneticAsyncProvider apiWrapper={getSignoutsToday} refreshRate={30*1000} contextProvider={SignoutsTodayContext.Provider}>{props.children}</GeneticAsyncProvider>
}
