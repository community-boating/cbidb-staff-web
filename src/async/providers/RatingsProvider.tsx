...
export default function RatingsProvider(props: {children?: React.ReactNode}){
    return <AsyncStateProvider apiWrapper={getRatings} initState={defaultRatings} makeChildren={(state) => {return <RatingsContext.Provider value={state}>{props.children}</RatingsContext.Provider>}}/>
}